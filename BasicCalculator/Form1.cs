...
namespace BasicCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void CEButton_Click(object sender, EventArgs e)
        {
            ...
            // Sets result area back to default text
        ...
        private string ParseOperation()
        {
            try
            {
                ...
                for (int i = 0; i < input.Length; i++)
                {
                    ...
                    // Check if the curent character is a number
                    ...
                    {
                        // If we are on the right side already, we now need to calculate our current
                        // operation and set the result to the left side of the next operation
                        if (!leftSide)
                        {
        ...
        /// <summary>
        /// Attempts to add a new character to the current number, 
        /// checking for valid characters as it goes
        /// </summary>
